...
CREATE TABLE `examen` (
  ...
  `nom_examen` varchar(45) DEFAULT NULL,
  `fecha_inicio` datetime DEFAULT NULL,
  `fecha_fin` datetime DEFAULT NULL,
  `duracion` time DEFAULT NULL,
  `porcentaje` varchar(45) DEFAULT NULL,
  `maxima_nota` int(11) DEFAULT NULL,
  `minima_nota` int(11) DEFAULT NULL,
  `num_preguntas` int(11) DEFAULT NULL,
  `publicar_nota` varchar(45) DEFAULT NULL,
  `instr_examen` varchar(500) DEFAULT NULL,
...
INSERT INTO `examen` (`id_examen`, `id_profesor`, `nom_examen`, `fecha_inicio`, `fecha_fin`, `duracion`, `porcentaje`, `maxima_nota`, `minima_nota`, `num_preguntas`, `publicar_nota`, `instr_examen`, `Activo`) VALUES
(5, 1, 'examen1', '1970-01-01 00:00:00', '2019-09-07 00:00:00', '01:30:00', '65', 60, 30, 100, 'si', 'hacer', 1),
(6, 1, 'vcxvcx', '1970-01-01 00:00:00', '2019-10-07 00:00:00', '02:00:00', '75', 72, 26, 80, 'no', 'cvcxv', 1),
(11, 1, 'prueba 2', '1970-01-01 00:00:00', '1970-01-01 00:00:00', '03:00:00', '34', 41, 9, 37, 'si', 'luis', 1),
...
CREATE TABLE `preguntas` (
  ...
  `img_pista` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `profesor` (`id_profesor`, `id_datos`, `id_carrera`) VALUES
(1, 2, 1),
(2, 4, 1);
...
CREATE TABLE `respuestas` (
  ...
  `verdadero` tinyint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `select_indiv_examen`
--
...
CREATE TABLE `usuario` (
  ...
  `recupera_clave` varchar(45) DEFAULT NULL,
  `activo` tinyint(4) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `usuario` (`id_usuarios`, `id_datos`, `nickname`, `password`, `tipo_usuario`, `recupera_clave`, `activo`) VALUES
(1, 1, 'luis', 'admin', 1, 'token', 1),
(2, 2, 'jose', 'admin', 0, 'token', 1);
...
ALTER TABLE `examen_grupo`
  ...
  ADD KEY `id_examen` (`id_examen`,`id_grupo`),
...
--
ALTER TABLE `datos_personales`
  ADD CONSTRAINT `datos_personales_ibfk_1` FOREIGN KEY (`id_ubicacion`) REFERENCES `ubicacion` (`id_ubicacion`);

--
-- Filtros para la tabla `examen`
--
ALTER TABLE `examen`
  ADD CONSTRAINT `examen_ibfk_1` FOREIGN KEY (`id_profesor`) REFERENCES `profesor` (`id_profesor`);
...
--
ALTER TABLE `integrantes`
  ADD CONSTRAINT `integrantes_ibfk_2` FOREIGN KEY (`id_grupo`) REFERENCES `grupos` (`id_grupo`),
...
--
ALTER TABLE `profesor`
  ADD CONSTRAINT `profesor_ibfk_4` FOREIGN KEY (`id_carrera`) REFERENCES `carreras` (`id_carrera`),
  ADD CONSTRAINT `profesor_ibfk_5` FOREIGN KEY (`id_datos`) REFERENCES `datos_personales` (`id_datos`);

--
-- Filtros para la tabla `respuestas`
--
ALTER TABLE `respuestas`
  ADD CONSTRAINT `respuestas_ibfk_1` FOREIGN KEY (`id_preguntas`) REFERENCES `preguntas` (`id_pregunta`);

--
-- Filtros para la tabla `resultado`
--
ALTER TABLE `resultado`
  ADD CONSTRAINT `resultado_ibfk_3` FOREIGN KEY (`id_examen`) REFERENCES `examen` (`id_examen`),
  ADD CONSTRAINT `resultado_ibfk_4` FOREIGN KEY (`id_postulante`) REFERENCES `postulante` (`id_postulante`);

--
-- Filtros para la tabla `select_indiv_examen`
--
ALTER TABLE `select_indiv_examen`
  ADD CONSTRAINT `select_indiv_examen_ibfk_3` FOREIGN KEY (`id_examen`) REFERENCES `examen` (`id_examen`),
  ADD CONSTRAINT `select_indiv_examen_ibfk_4` FOREIGN KEY (`id_postulante`) REFERENCES `postulante` (`id_postulante`);

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`id_datos`) REFERENCES `datos_personales` (`id_datos`);
COMMIT;
